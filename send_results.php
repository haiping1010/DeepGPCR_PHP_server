...
//$file_path = "/var/www/html/DeepBindBC/jobs/job$job_id/$file_name";
...
$mail->Host = 'smtp.xxxxxxx.com';  // Specify main and backup SMTP servers
...
$mail->Subject = "DeepGPCR Results: Job $job_id";
$mail->Body    = $message;
