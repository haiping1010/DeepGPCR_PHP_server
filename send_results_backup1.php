...
$mail->Host = 'mail.cstnet.cn';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'haipingzhang';                 // SMTP username
$mail->Password = 'haipingzhang123';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

$mail->setFrom('haipingzhang@siat.ac.cn', 'haipingzhang');
...
$mail->Subject = "DeepBindPoc Results: Job $job_id";
$mail->Body    = $message;
